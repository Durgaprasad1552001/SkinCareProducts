...
<%@ page import="com.Example.models.getlikedProduct" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        function confirmRefresh() {
            return confirm("Are you sure you want to refresh liked products?");
        }
...
<body>
    <div class="container">
        ...
        <div class="btn-container">
            <form id="viewlikedProductsForm" action="getLikedProductsServlet" method="get" onsubmit="return confirmRefresh();">
                <button type="submit" class="btn">Refresh Liked Products</button>
            </form>
        ...
        <div class="product-grid">
            <% List<getlikedProduct> likedProducts = (List<getlikedProduct>) request.getAttribute("likedProducts");
            if (likedProducts != null && !likedProducts.isEmpty()) {
                java.util.Iterator<getlikedProduct> iterator = likedProducts.iterator();
                while (iterator.hasNext()) {
                    getlikedProduct product = iterator.next();
            %>
                    <div class="product">
            ...
            %>
                <p class="message">No liked products found.</p>
            <% } %>
        </div>
    </div>
</body>
